...
export const founderDiagnosticFallbackSections: StrapiSection[] = [
  {
    ...
    lede: ", for founders who already shipped. In 14 days you get a written diagnosis: the one thing blocking your startup's growth, named. What to fix first. And what to stop doing.",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        quote: "An investor asked who my customer was. I talked for two minutes and said nothing.",
        id: id()
      },
      {
      ...
      },
      {
        ...
        quote: "My co-founder and I split the equity before either of us knew what we'd do. Now I'm not sure I trust him.",
        id: id()
      },
      {
      ...
      },
      {
        ...
        quote: "What if I'm just not startup material? Nine founders in ten cannot tell a broken business from a broken founder, and that difference takes about two weeks to establish.",
        id: id()
      }
    ],
    closing: "The good news: most founders never get past \"it's been rough.\" Naming it puts you ahead of most founders.",
    id: id()
  },
  {
    ...
    lede: "You're skilled. Smart. Competent. You know your industry and you know your core. Then the last nine months changed the game: building got cheap, attention got expensive, and the dimension that decides everything now is the one nobody ever trained you in. So your ICP becomes everyone. Your messaging becomes everything. And your pipeline becomes nothing.",
    cardTitle: "15 founders this year.",
    cardBody: "Every single one had misread their use case. That one mistake produced all of this:",
    chips: [
      {
        label: "Broad roadmap",
        id: id()
  ...
  },
  {
    ...
    lede: "You can know exactly who it's for and what to say to them. Every feature you build has a reason you could defend out loud. And you know this year is going somewhere.\n\nStartup culture calls the first one normal. It doesn't have to be. It can be a lot quieter than this.",
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "I quiz you and your co-founders, because the gap between your answers is often the whole diagnosis.",
        id: id()
      },
      {
        title: "Pitch test",
      ...
      },
      {
        ...
        body: "I get into the product myself and hit whatever your buyer hits. Four angles, eight blind spots. Several will be open. I name the one to close first, and the order for the rest.",
        id: id()
      }
    ],
    id: id()
    ...
    cards: [
      {
        ...
        changeBody: "He cut features to the critical use cases and reduced monthly burn by 50%, which saved the company from bankruptcy.",
        id: id()
      },
      {
        name: "Kirill",
  ...
  },
  {
    ...
    steps: [
      {
        title: "You submit",
        body: "Pay €750 by card or EU/US bank transfer. A light service agreement arrives automatically and I sign an NDA. Then you upload your landing, deck, and numbers, and fill the intake.",
        id: id()
      },
      {
        title: "Conflict check",
        body: "I review for any conflict with current or past clients. If there is one, I tell you immediately and refund you in full.",
        id: id()
      },
      {
        title: "I investigate",
        body: "I send all my data requests at once. Once you have completed them, the work starts. If I need clarification I reach out, otherwise you hear nothing until it lands.",
        id: id()
      },
      {
        title: "Your diagnosis lands",
        body: "In 14 days: the detailed written report, a walkthrough if you want one, and lifetime WhatsApp access for any questions after.",
        id: id()
      }
    ],
    id: id()
  },
  {
    ...
    eligibleItems: [
      {
        text: "You have a product, MVP or beyond. Pre-MVP works too, if you have a bulletproof roadmap for a genuinely technical product.",
        id: id()
      },
      {
  ...
  },
  {
    ...
    body: "Every month you wait, you spend another month of runway in a direction nobody has checked. Burn €5,000 a month, and three months of guessing costs you €15,000. The diagnosis costs €750, and it is refundable.",
    ctaText: "I'm in",
    ctaHref: "#book",
  ...
  },
  {
    ...
    guarantee: "If you do not walk away with more clarity than you have had in months, you get your money back. No pitch. No generic frameworks.",
