export const consultingServicesPageData = {
  title: "Consulting Services",
  slug: "consulting-services",
  seo: {
    metaTitle: "Consulting Services | KB&G",
    metaDescription:
    ...
    canonicalUrl: "https://kbngconsulting.com/consulting-services",
  },
  sections: [
    {
      ...
      logos: [
        { label: "Arcosa", imageUrl: "/images/consulting-services/arcosa.png" },
        { label: "Breedon", imageUrl: "/images/consulting-services/breedon.png" },
        { label: "Firth", imageUrl: "/images/consulting-services/firth.png" },
        { label: "Kraemer", imageUrl: "/images/consulting-services/kraemer.png" },
        { label: "Peckham", imageUrl: "/images/consulting-services/peckham.png" },
        { label: "Stevenson", imageUrl: "/images/consulting-services/stevenson.png" },
      ],
    },
    {
