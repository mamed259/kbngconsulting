import type { CsAbeSectionData } from "@/types/strapi";
import { Container } from "@/components/ui/Container";

type Props = Omit<CsAbeSectionData, "__component">;

export function CsAbeSection({ sectionConfig, heading, lead, steps }: Props) {
  return (
